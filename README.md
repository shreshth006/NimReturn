...
Phase 1 merchant and Phase 2 purchase/Passport implementations are code-complete at their physical boundaries. Phase 3 claims and Phase 4 refunds are each approximately 90% experimental/code-complete. Refunds are exact, direct payments from the purchase-bound settlement address to the chain-derived buyer and become verified only from independently fetched execution/finality evidence. Actual Nimiq Pay signer/sender routing remains unproven. Phase 0 remains 98%, Phase 1 92%, and Phase 2 90%; every physical policy, payment, Passport, claim, resolution, refund, reload, and mobile check remains open pending the project lead's explicit personal results. D-029 corrects an earlier false attribution of blanket phase authority and authorized Phase 4 only; it does not waive testing or authorize Phase 5. See the [consolidated device checklist](./docs/evidence/consolidated-device-validation.md), [STATUS.md](./STATUS.md), and [MEMORY.md](./MEMORY.md).
